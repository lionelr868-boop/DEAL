...
export default function EquipmentOwnerDashboard() {
  ...
  const rentals = [
    {
      id: '1',
      equipment: { ar: 'رافعة برجية 50 طن', fr: 'Grue à tour 50T' },
      renter: { ar: 'شركة البناء الوطنية', fr: 'Entreprise Nationale de Bâtiment' },
    ...
    {
      id: '2',
      equipment: { ar: 'حفارة كاتربيلر', fr: 'Excavatrice Caterpillar' },
      renter: { ar: 'مؤسسة الأشغال العمومية', fr: 'Entreprise de Travaux Publics' },
    ...
    {
      id: '3',
      equipment: { ar: 'خلاطة خرسانة', fr: 'Bétonnière' },
      renter: { ar: 'أحمد بن سعيد', fr: 'Ahmed Ben Said' },
    ...
    {
      id: '4',
      equipment: { ar: 'مولد كهربائي 100 كفاس', fr: 'Groupe électrogène 100KVA' },
      renter: { ar: 'مشاريع سوق أهراس', fr: 'Projets Souk Ahras' },
                  ...
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-bold text-sm text-deal-navy truncate">
                        {getLocalizedValue(rental.equipment.ar, rental.equipment.fr)}
                      </p>
                      <p className="text-xs text-muted-foreground mt-0.5">
                        {getLocalizedValue(rental.renter.ar, rental.renter.fr)}
                      </p>
                    ...
                    <div className="flex flex-col items-end gap-2 flex-shrink-0">
                      <span className="text-sm font-bold text-deal-navy">
                        {rental.total.toLocaleString()} {t.common.currency}
                      </span>
