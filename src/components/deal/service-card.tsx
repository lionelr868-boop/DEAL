...
export default function ServiceCard({ service, index = 0 }: ServiceCardProps) {
  ...
  return (
    <motion.div
      ...
      className="card-3d glow-effect card-cursor-shadow cursor-shadow-orange rounded-2xl overflow-hidden bg-white shadow-sm hover:shadow-xl cursor-pointer group relative"
      style={tiltStyle}
    >
      {/* Spotlight overlay */}
